...
Функция-декоратор ***log*** автоматически логирует результат выполнения функции или возникшие ошибки:
...
+ Тестирование логирования функции в отдельный файл и в консоль.
+ Параметризация тестов с использованием различных типов входных данных.

### Модуль transactions_files.py

Функции ***transactions_csv*** и ***transactions_xlsx*** считывают финансовые операции из CSV и Excel файлов, а также
выводят список словарей с транзакциями:

```
# вызов функций
transactions_csv(path_file_csv)
transactions_xlsx(path_file_xlsx)
...
+ Тестирование правильности чтения CSV и Excel файлов.
+ Проверка, что функция корректно обрабатывает с несуществующими файлами.